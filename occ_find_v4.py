...
Directory called photData containing:
    ...
    4. Plot of photometry apertures overlaid onto detected sources.
'''
...
def occ_find(path, spool_file, make_dir, fwhm, thresh_factor):
    ...
    print(mean, med, std)                                     #sigma_clipped_stats may not be correct here due to exponential dist. 
    threshold = thresh_factor*med                             #of pixel values in EMCCD.
